...
def draw_transducer_empty(trans, off_file, ax):
	# Draw transducer trans
	#Draw in mm's
	draw_coef = 1000
...
def draw_figs(tr):
	...
	# grid = AxesGrid(fig, (0.1, 0.25, 0.8, 0.9), nrows_ncols=(1, 4),
	# 	axes_pad = 0.35,
	# 	share_all=True,
	# 	label_mode = "L",
	# 	# cbar_location = "right",
	...
	draw_transducer_empty(tr[1]['trans'], tr[1]['off'], grid[0])
	for i in range(1,4):
	...
	plt.savefig(r"d:\Downloads\Calc\fig_table_transducers.png", dpi=300, pad_inches=0.0)
	plt.show()
